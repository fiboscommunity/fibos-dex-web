...
function loadChart(props) {
  ...
  window.tvWidget = new Widget({
    ...
    symbol,
    interval: '1D',
    container_id: 'chart_container_mobile', // 容器元素ID
    ...
    custom_css_url: './mychart_mobile.css',
    chartType: 1,
  })
...
function CandlestickChart(props) {
  ...
  return (
    <div className={styles.chartWrapper}>
      ...
      <div
        className={styles.chart_body}
        onClick={() => {
          setHideMask(true)
        }}>
        <div id="chart_container_mobile" className={styles.chart_container} />
        {!hideMask && <div className={styles.chartMask} />}
      </div>
    </div>
  )
}
