...
import { producitonCount, pollInterval, host } from 'Config'
...
class ProductionGrid extends PureComponent {
  ...
  requestForProductionData = () => {
    ...
    requestForTotalOfProductionData(
      {},
      {
        successCb: () => {
          requestForProductionData(
            { page: 1, pagesize: producitonCount },
            {
              successCb: () => {
  ...
  render() {
    const { productionGridSpinning, gridDataTotal, gridData } = this.props
    ...
    return (
      <div className={styles.wrapper}>
          ...
          <div className={styles.gridWrapper}>
            {gridData.map((item, index) => {
              ...
              if (!id) {
                ...
                return <GridCard key={tmpKey} isBlank spinning={productionGridSpinning} />
              }
        ...
        {gridDataTotal && gridDataTotal > producitonCount && (
